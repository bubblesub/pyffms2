...
TAudioNameCallback = CFUNCTYPE(c_int, STRING, c_int, POINTER(FFMS_AudioProperties), STRING, c_int, c_void_p)
...
FFMS_CreateVideoSource.argtypes = [STRING, c_int, POINTER(FFMS_Index), c_int, c_int, POINTER(FFMS_ErrorInfo)]
FFMS_CreateAudioSource = lib.FFMS_CreateAudioSource
FFMS_CreateAudioSource.restype = POINTER(FFMS_AudioSource)
FFMS_CreateAudioSource.argtypes = [STRING, c_int, POINTER(FFMS_Index), c_int, POINTER(FFMS_ErrorInfo)]
...
FFMS_GetFrame.argtypes = [POINTER(FFMS_VideoSource), c_int, POINTER(FFMS_ErrorInfo)]
FFMS_GetFrameByTime = lib.FFMS_GetFrameByTime
FFMS_GetFrameByTime.restype = POINTER(FFMS_Frame)
FFMS_GetFrameByTime.argtypes = [POINTER(FFMS_VideoSource), c_double, POINTER(FFMS_ErrorInfo)]
FFMS_GetAudio = lib.FFMS_GetAudio
FFMS_GetAudio.restype = c_int
FFMS_GetAudio.argtypes = [POINTER(FFMS_AudioSource), c_void_p, int64_t, int64_t, POINTER(FFMS_ErrorInfo)]
try:
    FFMS_SetOutputFormatV2 = lib.FFMS_SetOutputFormatV2
    FFMS_SetOutputFormatV2.restype = c_int
    FFMS_SetOutputFormatV2.argtypes = [POINTER(FFMS_VideoSource), POINTER(c_int), c_int, c_int, c_int, POINTER(FFMS_ErrorInfo)]
except AttributeError:
    FFMS_SetOutputFormatV2 = None
    FFMS_SetOutputFormatV = lib.FFMS_SetOutputFormatV
    FFMS_SetOutputFormatV.restype = c_int
    FFMS_SetOutputFormatV.argtypes = [POINTER(FFMS_VideoSource), int64_t, c_int, c_int, c_int, POINTER(FFMS_ErrorInfo)]
...
try:
    ...
    FFMS_SetInputFormatV.argtypes = [POINTER(FFMS_VideoSource), c_int, c_int, c_int, POINTER(FFMS_ErrorInfo)]
...
#FFMS_SetPP.argtypes = [POINTER(FFMS_VideoSource), STRING, POINTER(FFMS_ErrorInfo)]
...
FFMS_GetFirstTrackOfType.argtypes = [POINTER(FFMS_Index), c_int, POINTER(FFMS_ErrorInfo)]
FFMS_GetFirstIndexedTrackOfType = lib.FFMS_GetFirstIndexedTrackOfType
FFMS_GetFirstIndexedTrackOfType.restype = c_int
FFMS_GetFirstIndexedTrackOfType.argtypes = [POINTER(FFMS_Index), c_int, POINTER(FFMS_ErrorInfo)]
...
FFMS_WriteTimecodes.argtypes = [POINTER(FFMS_Track), STRING, POINTER(FFMS_ErrorInfo)]
FFMS_MakeIndex = lib.FFMS_MakeIndex
FFMS_MakeIndex.restype = POINTER(FFMS_Index)
FFMS_MakeIndex.argtypes = [STRING, c_int, c_int, TAudioNameCallback, c_void_p, c_int, TIndexCallback, c_void_p, POINTER(FFMS_ErrorInfo)]
FFMS_DefaultAudioFilename = lib.FFMS_DefaultAudioFilename
FFMS_DefaultAudioFilename.restype = c_int
FFMS_DefaultAudioFilename.argtypes = [STRING, c_int, POINTER(FFMS_AudioProperties), STRING, c_int, c_void_p]
...
FFMS_CreateIndexerWithDemuxer.argtypes = [STRING, c_int, POINTER(FFMS_ErrorInfo)]
FFMS_DoIndexing = lib.FFMS_DoIndexing
FFMS_DoIndexing.restype = POINTER(FFMS_Index)
FFMS_DoIndexing.argtypes = [POINTER(FFMS_Indexer), c_int, c_int, TAudioNameCallback, c_void_p, c_int, TIndexCallback, c_void_p, POINTER(FFMS_ErrorInfo)]
...
FFMS_IndexBelongsToFile.argtypes = [POINTER(FFMS_Index), STRING, POINTER(FFMS_ErrorInfo)]
FFMS_WriteIndex = lib.FFMS_WriteIndex
FFMS_WriteIndex.restype = c_int
FFMS_WriteIndex.argtypes = [STRING, POINTER(FFMS_Index), POINTER(FFMS_ErrorInfo)]
